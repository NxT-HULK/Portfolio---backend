                ...
                <body
                    ...
                    <div
                                                                                            ...
                                                                                            <a href="https://github.com/mernwala"
                                                                                                ...
                                                                                                <svg role="img" viewBox="0 0 40 40"
                                                                                                    ...
                                                                                                    <rect x="0.5" y="0.5" width="39"
                                                                                                        height="39" rx="100"
                                                                                                        fill="#181717" stroke="#181717">
                                                                                                    </rect>
                                                                                                    <svg role="img" viewBox="0 0 24 24"
                                                                                                        xmlns="http://www.w3.org/2000/svg"
                                                                                                        width="23px" height="23px"
                                                                                                        x="8.5" y="8.5" fill="#ffffff"
                                                                                                        color="#ffffff">
                                                                                                        <title>GitHub</title>
                                                                                                        <path
                        ...
                        <div style="margin-top: 1rem;">
                            <span style="display: block; color: #aaa; font-size: 14px;"> This is an automated email to deliver an
                                exciting update.
                            </span>
                            <span style="display: block; color: #aaa; font-size: 14px;"> Feel free to unsubscribe at any time by
                                clicking <a href="${process.env.FRONTENDHOST}/#/unsubscribe?email=${email}">here</a>. Your preferences
                                matter, and we want to ensure that you receive only the content that truly interests you. </span>
                        </div>
                    </div>
                </body>
                </html>
